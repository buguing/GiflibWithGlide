...
/**
 * link https://android.googlesource.com/platform/frameworks/ex/+/android-9.0.0_r16/framesequence/src/android/support/rastermill/FrameSequence.java
 */
public class FrameSequence {
    ...
    private static native FrameSequence nativeDecodeFile(String filePath);
    ...
    public static FrameSequence decodeFilePath(String filePath) {
